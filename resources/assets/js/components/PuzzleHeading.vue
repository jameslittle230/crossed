    ...
    <div class="puzzle-heading">
        <div class="settings-column">
            <svg version="1.1" id="Cog" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="31" height="31" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve">
        ...
        <div class="title-column">
            <input type="text" class="puzzle-title"
            v-bind:value="puzzleName"
            @blur="$emit('update:puzzleName', $event.target.value)"/>

            <p class="save-status">All data saved.</p>
        </div>
...
import applyTemplateButton from './ApplyTemplateButton.vue'
import inputDirectionSwitch from './InputDirectionSwitch.vue'
